...
(define (domain logistics)
  ...
  ; A airplain can be loaded if both the plance and the packages is at the location
  ; the result is that the package is no longer in the airport   but inside the plance
  ...
  ; load-trucks and airplane are similar: we could have a single load and unload for them, updating the hierarchy of the types
  ; but we should have a dedicated load/unload for drones   
  ...
  ; The result is that the package is at the airport of the plane and no longer in the plane
