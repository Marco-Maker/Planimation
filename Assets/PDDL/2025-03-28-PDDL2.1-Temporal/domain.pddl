...
(define (domain logistics)
  ...
  ; A plane can be loaded if both the plane and the packages is at the location
  ; the result is that the package is no longer at the aiport but inside the plance
  ...
  ; A truck can always drive between places inside cities
  (:action drive-truck
...
; A truck is now allowed to drive through places of connected cities
